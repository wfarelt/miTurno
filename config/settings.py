...
SPECTACULAR_SETTINGS = {
    "TITLE": "CitaPro API",
    "DESCRIPTION": "Multi-tenant appointment scheduling API for salons and barbershops.",
    "VERSION": "1.0.0",
}

CORS_ALLOW_ALL_ORIGINS = config("CORS_ALLOW_ALL_ORIGINS", cast=bool, default=True)

JWT_ACCESS_MINUTES = config("JWT_ACCESS_MINUTES", cast=int, default=15)
